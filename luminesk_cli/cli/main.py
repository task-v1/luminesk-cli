...
from luminesk_cli.core import diagnostic as dg
from luminesk_cli.core import manager as srv
from luminesk_cli.core.config import UserConfig
from luminesk_cli.core.messages import (
    MESSAGE_CATALOGS,
    normalize_language,
    set_language,
    t,
...
app = App(
    name="nesk",
    help="Luminesk-CLI: MCBE server composer.",
...
def delete(
    ...
    *,
    ...
    """Delete a stopped server from Luminesk-CLI."""
    config = _load_cli_config()
