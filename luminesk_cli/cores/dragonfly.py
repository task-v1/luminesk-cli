...
from luminesk_cli.core.base import GoCore
...
class DragonflyCore(GoCore):
    ...
    def download(
        ...
        from luminesk_cli.utils.github_releases import fetch_json, parse_github_repo_url
...
"""
        ...
        from luminesk_cli.utils.docker import get_docker_binary

        docker_bin = get_docker_binary()

        from luminesk_cli.core.launcher import ensure_docker_image
