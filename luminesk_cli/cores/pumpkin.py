...
from luminesk_cli.core.base import RustCore
from luminesk_cli.models.manager import DownloadedCore
from luminesk_cli.utils.downloads import download_url
...
class PumpkinCore(RustCore):
    ...
    def download(
        ...
        from luminesk_cli.utils.github_releases import get_release_asset_info
